...
```html
<script src="https://cdn.jsdelivr.net/npm/peace.js@1.1.7/dist/peace.min.js" async></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/peace.js@1.1.7/dist/peace.min.js" data-target="#footer" async></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/peace.js@1.1.7/dist/peace.min.js" data-theme="blue" async></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/peace.js@1.1.7/dist/peace.min.js" data-style="symbol" async></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/peace.js@1.1.7/dist/peace.min.js" data-auto="false" data-theme="green" async></script>
