...
```html
<script src="https://cdn.jsdelivr.net/peace.js/1.1.3/peace.min.js" data-target="#footer" async></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/peace.js/1.1.3/peace.min.js" data-auto="false" data-theme="green" async></script>
